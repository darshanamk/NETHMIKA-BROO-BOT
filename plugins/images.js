...
if (Config.WORKTYPE == 'private') {
    ...
    SL-BROO-BOT.addCommand({pattern: 'anime', fromMe: true, desc: 'random anime image'}, (async (message, match) => {
    ...
    SL-BROO-BOT.addCommand({pattern: 'SL-BROO-BOT', fromMe: true,dontAddCommandList: true}, (async (message, match) => {
        
    var r_text = new Array ();    
r_text[0] = "\nEda eda, mandankonappi.. Nee enne kooduthal mandan aakkatheda\n";
r_text[1] = "SL-BROO-BOTye tholpikkaan ningalkavilla. Jeevitathil SL-BROO-BOTye tholpichittundu… palarum… palavattom…😥😥 aarellum aaa sed bgm onn iduo...";
r_text[2] = "SL-BROO-BOT says i love you 😘";
r_text[3] = "SL-BROO-BOTyude yudhangal Company Kanan Povunnatheyuloo";
...
r_text[8] = "\n enne vilicho...?🧐 \n";
r_text[9] = "ente per SL-BROO-BOT ,ninte per donkey, backi ellarum monkey😼😼";
...
r_text[13] = ".song adich thangalude fav song name para SL-BROO-BOT ath download aakki theraam";
...
r_text[21] = "Kochi pazhaya kochiyellennariyam… pakshe SL-BROO-BOT pazhaya SL-BROO-BOT thanneya...😎\n\n";
r_text[22] = "Kaanaan oru look illanney ullu… bhayankara budhiya\n\n ninnak allatto enik SL-BROO-BOTk";
r_text[23] = "Ithalla ithinapparam chaadi kadannavananee K.K. SL-BROO-BOT";
...
await message.sendMessage(r_text[i]);
    ...
    SL-BROO-BOT.addCommand({pattern: 'anime', fromMe: false, desc:'random anime image '}, (async (message, match) => {
    ...
    SL-BROO-BOT.addCommand({pattern: 'wallpaper', fromMe: false, desc: Lang.WP}, (async (message, match) => {
    ...
    SL-BROO-BOT.addCommand({pattern: 'SL-BROO-BOT', fromMe: false,dontAddCommandList: true}, (async (message, match) => {
...
r_text[4] = "hi, how are you";
r_text[5] = "ennikk korch rest theroo...🥵🥵";
r_text[6] = "SL-BROO-BOT - eva - simsim \ningane ethra ethra paerugal aan alle enikk..😂🤣";
r_text[7] = "താനാരാണെന്ന് തനിക്ക് അറിയാന്‍ മേലങ്കില്‍താന്‍ എന്നോട്‌ ചോദിക്ക്.. താനാരണെന്ന്...തനിക്ക് ഞാന്‍ പറഞ്ഞു തരാംതാനാരാണെന്ന്...എന്നിട്ട്‌ഞാനാരാണെന്ന് എനിക്കാറിയാമൊന്നുതാനെന്നോട്‌ ചോദിക്ക്..അപ്പോ തനിക്ക് ഞാന്‍ പറഞ്ഞു തരാംതാനാരാണെന്നും ..ഞാനാരാണെന്നും - കുതിരവട്ടം പപ്പു, മണിച്ചിത്രതാഴ് ";
r_text[8] = "\n enne vilicho...?🧐 \n";
r_text[9] = "ente per SL-BROO-BOT ,ninte per donkey, backi ellarum monkey😼😼";
r_text[10] = "nee vilicha enikk villi kelkathe irrikkaan pattuo";
...
r_text[17] = "\n hey mishter ningalude per entha..?";
r_text[18] = "enikk njan und SL-BROO-BOT uyir";
r_text[19] = "\n eda sathyam para nee ente fan alle..\n ";
r_text[20] = "The coefficient's of linear expansions is the position of Haemoglobin in the atmosphere. But Why? Full Many gem of purests serene lay underneath the unfathomed ocean's unblossomeds ! But why? But why";
r_text[21] = "Kochi pazhaya kochiyellennariyam… pakshe SL-BROO-BOT pazhaya SL-BROO-BOT thanneya...😎\n\n";
r_text[22] = "Kaanaan oru look illanney ullu… bhayankara budhiya\n\n ninnak allatto enik SL-BROO-BOTk";
